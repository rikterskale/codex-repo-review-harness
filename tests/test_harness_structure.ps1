...
Assert-True (Test-Path "$root\scripts\Start-ReviewWizard.ps1") "Missing interactive review wizard"
...
Assert-True (Test-Path "$root\tests\test_review_wizard.ps1") "Missing interactive review wizard test"
